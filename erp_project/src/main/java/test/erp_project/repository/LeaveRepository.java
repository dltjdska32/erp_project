...
public class LeaveRepository {
    ...
    public List<LeaveLogOfAdminDto> findLeaveLogOfAdminList() {
        List<LeaveLogOfAdminDto> leaveLogOfAdminList = em.createQuery("select u.name, l.requestDate, l.startDate, l.endDate, d.deptName, l.checkStatus, u.remainedLeave, l.checkStatus, u.userId"
